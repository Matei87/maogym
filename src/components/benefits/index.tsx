...
const Benefits: FC<SetSelectedPageProp> = ({
  ...
  return (
    <section
      id='benefits'
      className='dark:bg-zinc-700 dark:text-gray-10 overflow-x-hidden'
    >
      <div className='mx-auto min-h-full w-5/6 py-20'>
        <motion.div onViewportEnter={() => setSelectedPage('benefits')}>
          ...
          <div className='mt-16 items-center justify-between gap-20 md:mt-28 md:flex'>
            {/* GRAPHIC */}
            <img
              className='mx-auto dark:brightness-[.8]'
            ...
            <div>
              ...
              <div className='relative'>
                <div className='before:absolute before:-top-20 before:-left-20 before:z-[1] before:content-abstractwaves before:dark:brightness-[.8]'>
                  <motion.div
                    initial='hidden'
                    whileInView='visible'
                    viewport={{ once: true, amount: 0.5 }}
              ...
              >
                <p className='my-5'>
                  ...
                  experience in the field and know that the most important part
                  in following such a regime is motivation.
                </p>
                <p className='mb-5'>
                  Stop thinking and start working today on the toned and healthy
                  body you've been dreaming of for so long! Regardless of the
                  reasons that guide you to set this goal, at Phoenix Gym you
                  will always find support and inspiration to achieve the
                  results you want!
                </p>
              </motion.div>
              ...
              <div className='relative mt-16'>
                <div className='before:absolute before:-bottom-20 before:right-20 before:z-0 before:content-sparkles before:dark:brightness-[.8]'>
