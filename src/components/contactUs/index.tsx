      ...
      <motion.div onViewportEnter={() => setSelectedPage('contactus')}>
        ...
        >
          ...
          <p className='my-5'>
            ...
            physical condition. Our programs have proven effective globally and
            have achieved unparalleled results. We invite you to message us if
            you have any question and take part in a training session with our
            team.
          </p>
        </motion.div>
